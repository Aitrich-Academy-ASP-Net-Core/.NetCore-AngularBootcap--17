...
namespace JobPortalMVC.Controllers
{
    public class JobProviderController : Controller
    {
        ...
        public IActionResult PostJob(JobDto jobDto)
        {
            ...
            {
                TempData["Error"] = "You must be associated with a company to post a job.";
                return RedirectToAction("Profile"); // or wherever you want to send them
            }

            jobDto.CompanyId = user.CompanyId.Value; // Safe because we already checked
