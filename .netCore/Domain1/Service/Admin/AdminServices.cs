...
namespace Domain.Service.Admin
{
    public class AdminServices : IAdminServices
    {
        ...
        public async Task<bool> DeleteByLocationIdAsync(Guid id)
        {
            return await _adminRepository.DeleteByLocationIdAsync(id);
        }
        ...
        public bool DeleteByIndustryId(Guid id)
        {
            return _adminRepository.DeleteByIndustryId(id);
        }
        ...
        {
            return _adminRepository.GetSeekerCount();
        }
        ...
        {
            var skills = await _adminRepository.GetAllAsync(); // or your EF context
