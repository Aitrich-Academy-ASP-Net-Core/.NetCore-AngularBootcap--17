...
namespace Domain.Service.Profile
{
    public class ProfileService : IJobSeekerProfileService
    {
        ...
        public async Task<JobSeekerProfile> AddProfileAsync(ProfileDTO addProfileDto)
        {
        ...
        public List<JobseekerQualificationDTo> GetQualification(Guid jobseekerId, Guid profileId)
        {

            var qualifications = _profileRepository.GetQualification(jobseekerId, profileId);
            if (qualifications == null || !qualifications.Any())
                return null;

            return mapper.Map<List<JobseekerQualificationDTo>>(qualifications);
